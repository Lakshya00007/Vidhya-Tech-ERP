...
export const erpNavigation: ErpMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'document-templates', label: 'Document Templates', target: { page: 'settings', view: 'document-templates' }, roles: settingsReaders },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'admission-form', label: 'Admission Form', target: { page: 'documents', view: 'admission-form' }, roles: owners },
      ...
      { id: 'transfer-certificates', label: 'Transfer Certificates', target: { page: 'documents', view: 'transfer-certificates' }, roles: owners },
